...
const QualityCare = () => {
  return (
    <div className="mt-[430px] lg:mt-10 mx-2 lg:grid lg:grid-cols-4 lg:grid-rows-2 lg:place-items-center lg:gap-5">
      <div className="lg:col-span-2">
        ...
        <p className="open-sans font-normal mb-2">
          ...
          treating illness. It's about building genuine relationships with our
          patients, listening intently to their concerns, and creating a
          personalized plan for optimal health.{" "}
        </p>
      </div>
      <div className="text-center my-2">
        <img src={HeartImg} alt="" className="mx-auto" />
        <h4 className="font-neueHaasDisplayMedium text-xl my-2">Cardiology</h4>
      ...
      <div className="text-center mb-2">
        ...
        <h4 className="font-neueHaasDisplayMedium text-xl my-2">Crutches</h4>
        <p className="opens-sans font-normal">
      ...
      <div className="text-center mb-2">
        ...
        <h4 className="font-neueHaasDisplayMedium text-xl my-2">Pulmonary</h4>
        <p className="opens-sans font-normal">
      ...
      <div className="text-center mb-2">
        ...
        <h4 className="font-neueHaasDisplayMedium text-xl my-2">Neurology</h4>
        <p className="opens-sans font-normal">
      ...
      <div className="text-center mb-2">
        ...
        <h4 className="font-neueHaasDisplayMedium text-xl my-2">Dentistry</h4>
        <p className="opens-sans font-normal">
          Bright smiles start here. Our dentists offer cleanings, fillings, and
          advanced procedures for your oral health.
        </p>
      </div>
    </div>
  );
